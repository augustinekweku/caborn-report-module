...
export const ColumnSelectionModal = ({open, setOpen, cancelButtonRef}:PropTypes) => {
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            ...
                            <div className='grid grid-cols-12 gap-5 mt-7'>
                                ...
                                <ColumnOne selectedColumn={selectedColumn} onClick={()=>setColumn(1)} />
                                </div>
                                                    <div className='col-span-6'>
                                                        <p className='mb-4'>Two Columns</p>
                                <ColumnTwo selectedColumn={selectedColumn} onClick={()=>setColumn(2)} />
                                </div>
                            </div>
